...
public class MailSenderUtil {
    ...
    public static String sendMail(final String username, final String password, String mailFromAddress, String mailToAddress, String subj, String msgText) throws Exception {
        try {
